...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def go_to_pose_goal(self, rpy):
    ...
    rpy_rot = R.from_euler('xyz', rpy, degrees=False) * R.from_euler('z', 45, degrees=True)
...
# z = 0 -> 45
# z = 1 -> -45
# theta = lerp(cur_height, z_min, z_max, theta_min, theta_max)
# theta = lerp(cur_z, 0, 1, -45, 45)


def lerp(z, min_height, max_height, min_angle, max_angle):
    return min_height + (z - min_height)*(max_angle - min_angle) / (max_height - min_height)
