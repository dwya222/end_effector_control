...
# Initial states, if we are moving to these then don't record
...
class PathRecorder():
    ...
    def init_subs(self):
        ...
        self.initializing_test_sub = rospy.Subscriber("/initializing_test", Bool,
                                                      self.initializing_cb, queue_size=1)
    ...
    def initializing_cb(self, initializing_msg):
        self.initializing = initializing_msg.data
